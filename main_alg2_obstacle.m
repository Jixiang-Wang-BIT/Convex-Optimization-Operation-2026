...
%     "CON" — 凸优化双层迭代（Algorithm 2，默认）
%     "NLP" — 非线性规划（fmincon SQP，直接施加障碍约束）
clear all; clc;
close all
...
save(fullfile(params.results_dir,['obstacle_case1' suffix '.mat']), ...
    'sol','traj','params','obstacles','r_init','waypoints');
plot_alg2_results(traj,sol,obstacles,params,['obstacle_case1' suffix]);
